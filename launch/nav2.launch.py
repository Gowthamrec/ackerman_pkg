...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('ackerman_pkg')
    ...
    # Environment variable to flush logs immediately
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        description='Full path to ROS2 parameters file for all nodes'
    )
    ...
    # Launch Nav2 nodes (non-composable)
    ...
    # Launch Nav2 nodes as composable nodes
